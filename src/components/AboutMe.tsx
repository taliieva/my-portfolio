  ...
  return (
    <div className="w-full md:p-[30px] flex flex-col gap-[30px]">
      ...
      <p className="max-w-[800px] leading-relaxed text-gray-200 text-[14px] md:text-[18px]">
        ...
        technical knowledge with strong mentorship abilities. Proficient in
        modern web technologies and frameworks, delivering high-quality
        solutions in both professional projects and educational settings. Adept
        at fostering a collaborative learning environment and guiding students
        to excel in web development through structured, hands-on approaches.
      </p>
    </div>
  );
}
